...
[![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://github.com/IngLuisGarcia17/EverPeak_clean_share/blob/main/EverPeak_clean_share.ipynb)

O:

1. Abre el archivo `.ipynb` en GitHub
2. Haz clic en open Colab
